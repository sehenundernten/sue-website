      ...
      <section className="container max-w-4xl mx-auto pt-48 pb-28">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              <h2 className="text-2xl font-bold text-brand-blue">2. Hosting</h2>
              <p>
                Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
              </p>
              <h3 className="text-xl font-bold">Externe Hosting</h3>
              <p>
            ...
            <h3 className="text-xl font-bold">SSL- bzw. TLS-Verschlüsselung</h3>
            <p>
