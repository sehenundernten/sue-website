        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-lg xl:text-xl font-bold">Externe Hosting</h3>
              <p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-lg xl:text-xl font-bold">Datenschutz</h3>
              <p>
              ...
              <p>
                ...
                <br />
                Vertreten durch Nathanael Dehn
                <br />
                Mathildenstraße 10
                <br />
                12459 Berlin
              ...
              <h3 className="text-lg xl:text-xl font-bold">Speicherdauer</h3>
              <p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-lg xl:text-xl font-bold">Cookies</h3>
              <p>
              ...
              <h3 className="text-lg xl:text-xl font-bold">Kontaktformular</h3>
              <p>
            ...
            <p>
              Quelle:{" "}
              <a href="https://www.e-recht24.de/datenschutz-generator.html">
                https://www.e-recht24.de/datenschutz-generator.html
              </a>
            </p>
          </div>
        </div>
